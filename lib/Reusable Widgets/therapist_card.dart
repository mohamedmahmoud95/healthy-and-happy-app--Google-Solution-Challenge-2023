                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        children: [
                          ...
                          Text(widget.therapist.name, style: const TextStyle(color: mainPurple, fontSize: 20),),
                      ...
                      children: [
                        ...
                        const CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 12,
                            backgroundColor: Colors.transparent,
                            foregroundImage: AssetImage('assets/icons/doctor_scope.png',),
                       ...
                       //  Icon( color: lavender, icon: Image.asset('assets/icons/doctor_headset.png')),
                          Expanded(child: Text(widget.therapist.jobTitle, style: const TextStyle(color: navyBlue, fontSize: 12),)),
                          ],
                          ),
                          Row(
                            children: [
                              ...
                              Text(widget.therapist.sessionsLocation, style: const TextStyle(color: navyBlue, fontSize: 12),),
                            ],
                          ),
                          Row(
                            children: [
                              const CircleAvatar(
                                ...
                                child: CircleAvatar(
                                  radius: 12,
                                  backgroundColor: Colors.transparent,
                                  foregroundImage: AssetImage('assets/icons/money.png',),
                                  foregroundColor: lavender,
                                ),
                              ),
                              const SizedBox(width: 10,),
                              Text('EGP${widget.therapist.pricePerSession.toInt()}', style: const TextStyle(fontSize: 15, color: mainPurple),),
                            ],
                          ),
                        ],
                      ),
